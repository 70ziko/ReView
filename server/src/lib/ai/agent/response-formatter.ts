...
export const AlternativeProduct = z.object({
  ...
  score: z.number().describe("The rating of the alternative product"),
});

export const PriceRange = z.object({
  min: z.number().describe("The minimum price of the product"),
  avg: z.number().describe("The average price of the product"),
});
...
export const ResponseFormatter = z.object({
  ...
  prices: PriceRange.describe("Price information for the product"),
  product_id: z.string().describe("The unique identifier for the product"),
  category: z.string().describe("The product category path"),
});
